    ...
    <div class="container">
        ...
        <form action="{{ route('blogs.update', $blog->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="editor" name="desc" rows="5" required>{{ old('desc', $blog->desc) }}</textarea>
            </div>
            <div class="form-group">
                <label for="desc2" class="form-label">Content 2</label>
                <textarea class="form-control" id="editor1" name="desc2" rows="5" required>{{ old('desc2', $blog->desc2) }}</textarea>
            </div>
            ...
            <div class="row">
                <div class="form-group">
                    ...
                    <input type="datetime-local" class="form-control" id="publish_at" name="publish_at"
                        value="{{ old('publish_at', $blog->publish_at) }}" required>
                </div>
                <div class="form-group">
