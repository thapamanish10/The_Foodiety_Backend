...
@section('content')
    <main class="dashboardContainer">
        ...
        <div class="detailsformBody">
            <form action="{{ route('blog.image.store', $data->id) }}" method="POST" enctype="multipart/form-data"
                id="" class="form">
                @csrf
                <div class="formHeading">
                    ...
                    <div class="buttonDiv">
                        <button class="formBtn cancle" type="button" onclick="window.history.back();">
                            <span>Cancel</span>
