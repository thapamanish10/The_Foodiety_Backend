...
@section('content')
    <main class="dashboardContainer">
        ...
        <div class="detailsformBody">
            <form action="{{ route('business.image.store', $data->id) }}" method="POST" enctype="multipart/form-data"
                id="" class="form">
                @csrf
                ...
                <div class="formBody">
                    <div class="formGroup" hidden>
                        ...
                        <input type="text" value="{{ $data->id }}" name="about_id" id="product_id">
                    </div>
                    <div class="formGroup">
                    ...
                    <div class="formGroup" hidden>
                        <label for="image_text">IMAGE DESC: <span class="imp">*</span></label>
