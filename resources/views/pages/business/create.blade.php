...
<div class="navigationHeading">
        ...
        <div class="detailsformBody">
            <form 
                action="{{ isset($about->id) ? route('business.update', $about->id) : route('business.store') }}" 
                method="POST" 
            ...
            >
                ...
                <div class="formBody">
                    ...
                    <div class="formGroupImage">
                        ...
                        <img src="" alt="Selected Image" id="selectedImage" style="display:none; max-width: 100%; max-height: 300px; margin-top: 10px;">
                    ...
                    <div class="row">
                        ...
                        <div class="formGroup">
                            ...
                            <input type="text" name="optional_phone_number" id="optional_phone_number" value="{{ old('optional_phone_number') }}">
                        </div>
                        <div class="formGroup">
                    ...
                    <div class="row">
                        <div class="formGroup">
                            ...
                            <input type="text" name="tiktok_link" id="tiktok_link" value="{{ old('tiktok_link') }}">
                        </div>
                        <div class="formGroup">
                            <label for="threads_link">THREADS LINK:<span class="imp">*</span></label>
                            <input type="text" name="threads_link" id="threads_link" value="{{ old('threads_link') }}">
                        </div>
                    </div>
                    <div class="formGroup">
                        <label for="about_text">COMPANY ABOUT TEXT:<span class="imp">*</span></label>
                        <textarea type="text" cols="30" rows="10" name="about_text" id="editor">{{ old('about_text') }}</textarea>
                    </div>
                </div>
            </form>
            @if (session('success'))
