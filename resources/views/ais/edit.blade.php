...
@section('content')
    ...
    <div class="container">
        ...
        <form action="{{ route('ais.update', $ai) }}" method="POST" enctype="multipart/form-data" id="blogForm">
            @csrf
            @method('PUT')
            <div class="form-group">
                <label for="name" class="form-label"> Name</label>
                <input type="text" class="form-control" id="name" name="name" value="{{ $ai->name }}"
                    required>
            </div>
            <div class="form-group">
                <label for="description" class="form-label">Image Desc</label>
                <input type="text" class="form-control" id="description" name="description"
                    value="{{ $ai->description }}" required>
            </div>
            ...
            <div class="form-group-image">
                ...
                <img src="{{ asset('storage/' . $ai->image) }}" alt="{{ $ai->name }}" class="img-thumbnail mb-2"
