...
@section('content')
    ...
    <div class="container">
        ...
        <form method="POST" action="{{ route('ai-videos.store') }}" enctype="multipart/form-data" id="blogForm">
            @csrf
            ...
            <input type="hidden" class="form-control" id="type" name="type" value="ai-video" required>
