        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <div>
                <button type="submit" class="flex w-full justify-center rounded-md
                 ...
                 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Register Now</button>
            </div>
            <div class="text-sm text-center">
                <a href="{{ route('login') }}" class="font-semibold text-indigo-600 hover:text-indigo-500">Already registered?</a>
            </div>
            </form>
