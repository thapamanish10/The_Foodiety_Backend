...
@section('content')
    ...
    <div class="container">
        ...
        <form method="POST" action="{{ route('videos.update', $video) }}" enctype="multipart/form-data" id="blogForm">
            @csrf
            @method('PUT')
            ...
            <div class="form-group-buttons">
                ...
                <button type="submit" id="submitButton" class="btn-primary">Update Video</button>
            </div>
        </form>
    </div>
    {{-- Image Upload Script --}}
