...
@section('content')
    ...
    <div class="container">
        <div class="container-heading">
            ...
            <p>Provide information about the Image.</p>
        </div>
        <form action="{{ route('galleries.store') }}" method="POST" enctype="multipart/form-data" id="blogForm">
            @csrf
            ...
            <div class="form-group-buttons">
                <a href="{{ route('galleries.index') }}" class="btn-secondary">Cancel</a>
                <button type="submit" id="submitButton" class="btn-primary">Upload Image</button>
            </div>
        </form>
    </div>
    <script>
