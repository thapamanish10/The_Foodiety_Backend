        ...
        @foreach ($abouts as $about)
            <section class="contact-article-section">
                ...
                <div class="contact-article-section-follow-us">
                    <h3>Follow Us:</h3>
                    <img src="{{ url('fb.png') }}" alt="Facebook">
                    <img src="{{ url('in.png') }}" alt="Instagram">
                    <img src="{{ url('yt.png') }}" alt="Youtube">
                </div>
            </section>
        @endforeach
        <section class="contact-article-section">
            <form action="{{ route('messages.store') }}" method="POST">
                ...
                <div class="contact-article-section-form-group">
                    <div class="contact-article-section-form-group-row">
                        <input type="text" placeholder="First name" autofocus name="first_name">
                    ...
                    <textarea id="" cols="10" rows="10" name="message"></textarea>
