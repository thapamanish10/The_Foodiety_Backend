        ...
        <div class="card3-content-user-info">
            <div class="card3-content-user-info-sub">
                ...
                <div class="card3-content-user-info-user-details">
                    <h3>The Foodiety</h3>
                    <span>{{ $ai->created_at->format('d M') }}</span>
                </div>
            </div>
            <div class="card3-content-user-info-sub">
                <a href="{{ route('ais.download', $ai) }}" class="btn btn-success download-btn">Free Download <img
                        src="{{ url('arrow.png') }}" alt=""></a>
                {{-- <img src="{{ asset('share.png') }}" alt="" class="card3-content-share"> --}}
            </div>
        </div>
        <div class="card">
            <img src="{{ asset('storage/' . $ai->image) }}" class="card-img-top" alt="{{ $ai->name }}" loading="lazy">
        </div>
        <div class="card-body">
